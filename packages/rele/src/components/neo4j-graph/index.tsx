/*
 * @Author: sfy
 * @Date: 2023-03-28 22:55:53
 * @LastEditors: sfy
 * @LastEditTime: 2023-03-28 22:59:50
 * @FilePath: /vulture-design/packages/rele/src/components/neo4j-graph/index.tsx
 * @Description: update here
 */
import React, { useEffect } from 'react'
import { Neo4jd3 } from '@vuld/common'

export function ReactNeo4jGraph() {
  function init() {
